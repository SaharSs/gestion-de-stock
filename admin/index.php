...
if(isset($_POST['recherche']) AND !empty($_POST['recherche'])) {
 ...
 if(isset($_GET['page']))
	...
	$page=1;
     ...
     $q5 = "SELECT * FROM users WHERE name LIKE '%".$m."%'  limit $depart, $num_an  ";
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row['role'] ?></td>
		...
		<td>
          <a  onclick="return confirm('etes vous sur');"   href="supp.php?id=<?=$row['id'];?>"><i class="fas fa-trash"></i></a>
...
$q1="select id from users WHERE name LIKE '%".$m."%'";
...
if(isset($_GET['page']))
    ...
    $q3 = "SELECT * FROM users WHERE name LIKE '%".$l."%'  limit $depart, $num_an  ";
    ...
    <tr>
      ...
      <td><?php echo $row1['name'] ?></td>
       <td><?php echo $row1['role'] ?></td>
         <td>
          <a href="update.php?id=<?=$row1['id'];?>"><i class="fas fa-edit"></i></a>
		</td>
		<td>
          <a  onclick="return confirm('etes vous sur');"   href="supp.php?id=<?=$row1['id'];?>"><i class="fas fa-trash"></i></a>
...
$q1="select id from users WHERE name LIKE '%".$l."%'";
$r2=mysqli_query($c,$q1);
$annonce_t=mysqli_num_rows($r2);	
$pagesTotales = ceil($annonce_t/$num_an);
	?>
		...
		}else
{
	...
	$depart=($page-1)*	$num_an;
    $q1 = "SELECT * from users    limit $depart, $num_an ";
