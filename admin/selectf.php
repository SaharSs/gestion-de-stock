...
if(isset($_POST['recherche']) AND !empty($_POST['recherche'])) {
 ...
 if(isset($_GET['page']))
	...
	$page=1;
     ...
     $q5 = "SELECT * FROM fournisseur WHERE name LIKE '%".$m."%'  limit $depart, $num_an  ";
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row['name'] ?></td>
         ...
         <td>
          <a href="updatef.php?id=<?=$row['id'];?>"><i class="fas fa-edit"></i></a>
		</td>
		<td>
          <a  onclick="return confirm('etes vous sur');"   href="suppf.php?id=<?=$row['id'];?>"><i class="fas fa-trash"></i></a>
...
$q1="select id from fournisseur WHERE name LIKE '%".$m."%'";
...
if(isset($_GET['page']))
    ...
    $q3 = "SELECT * FROM fournisseur WHERE name LIKE '%".$l."%'  limit $depart, $num_an  ";
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row1['name'] ?></td>
         ...
         <td>
          <a href="updatef.php?id=<?=$row1['id'];?>"><i class="fas fa-edit"></i></a>
		</td>
		<td>
          <a  onclick="return confirm('etes vous sur');"   href="suppf.php?id=<?=$row1['id'];?>"><i class="fas fa-trash"></i></a>
...
$q1="select id from fournisseur WHERE name LIKE '%".$l."%'";
$r2=mysqli_query($c,$q1);
$annonce_t=mysqli_num_rows($r2);	
$pagesTotales = ceil($annonce_t/$num_an);
	?>
		...
		}else
{
	...
	$depart=($page-1)*	$num_an;
    $q1 = "SELECT * from fournisseur    limit $depart, $num_an ";
