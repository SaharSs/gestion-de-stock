...
if(isset($_POST['recherche']) AND !empty($_POST['recherche'])) {
 ...
 if(isset($_GET['page']))
	...
	$page=1;
     ...
     $q5 = "SELECT * FROM client WHERE name LIKE '%".$m."%'  limit $depart, $num_an  ";
...
$q1="select id from client WHERE name LIKE '%".$m."%'";
...
if(isset($_GET['page']))
    ...
    $q3 = "SELECT * FROM client WHERE name LIKE '%".$l."%'  limit $depart, $num_an  ";
		...
		}else
{
	...
	$depart=($page-1)*	$num_an;
    $q1 = "SELECT * from client   limit $depart, $num_an ";
