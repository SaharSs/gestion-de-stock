...
{
$id=$_GET['id'];
$l="select * from fournisseur where id=".$id;
$r1=mysqli_query($c,$l);
...
$ad=$_POST['adresse'];
$e=$_POST['email'];
$s="select * from fournisseur where email='$e' and id<>$id ";
$t=mysqli_query($c,$s);
$a=mysqli_num_rows($t);
if($a==0)
{
$q="update fournisseur set name='$n',tel='$tel',adresse='$ad',email='$e' where id=".$id;
$r=mysqli_query($c,$q);
}else
{
echo "exist";	
